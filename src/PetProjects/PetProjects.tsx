    ...
    <div className="swipe-to-slide">
      <Slider {...settings}>
        <div className="slide">
          ...
          />
          <a className="link-on-pet-project" href="https://fe-aug23-team3.github.io/product_catalog/#/">
        ...
        <div className="slide">
        <a className="link-on-pet-project" href="https://stim1.github.io/layout_landing-page/">
          <img
            src={arrowUpRight}
            alt="Arrow Up Right"
            className="slide-arrow"
